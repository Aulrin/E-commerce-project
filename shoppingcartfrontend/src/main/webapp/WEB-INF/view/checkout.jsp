            ...
            <div class="row cart-body">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>Rs. </span>${cartsum}</div>
                                </div>
                                <div class="col-xs-12">
                                    <small>Shipping</small>
                                    <div class="pull-right"><span><small>Rs. 100</small></span></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>Rs. </span>${total}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="form-group">
                             <div class="col-md-12"><strong>Select Payment Option:</strong></div>   
                        </div>
                        
                        <div class="form-group">
                        	<div class="col-md-12">
                        		<input type="radio" value="COD" name="paymentoption" onclick="javascript:CODCheck();" id="CashOnDelivery" checked>	Cash on Delivery<br>
                       			<input type="radio" value="DebitCard" name="paymentoption" id="DebitCard" checked>	Debit Card<br>
                        	</div>
                        </div>
                        
                        <div id="DebitCardOption">
                            <div class="form-group">
