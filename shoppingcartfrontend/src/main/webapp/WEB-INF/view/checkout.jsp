							...
							<div class="form-group">
								<div class="col-xs-12">
									...
									<div class="pull-right">
										<span>Rs. </span>${cartsum}</div>
								</div>
								<div class="col-xs-12">
									<small>Shipping</small>
									<div class="pull-right">
										<span><small>Rs. 500</small></span>
									</div>
								</div>
							</div>
							<div class="form-group">
					...
					<div
						...
						<div class="panel panel-danger">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<div class="col-md-12">
										<input type="radio" value="COD" name="paymentoption"
											onclick="javascript:CODCheck();" id="CashOnDelivery" checked>
										Cash on Delivery<br> <input type="radio"
											value="DebitCard" name="paymentoption" id="DebitCard" checked>
										Debit Card<br>
									</div>
								</div>
